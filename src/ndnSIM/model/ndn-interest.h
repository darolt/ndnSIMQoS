...
public:
  ...
  */
  ...
  void SetPriority (uint8_t priorityType);
  uint8_t CreateReservedField () const;
  void ExtractPriorityType (uint8_t reserved);
  void ExtractNackType(uint8_t reserved);
...
private:
  ...
  // JRO
  uint8_t m_priorityType;	/// priority type, goes to reserved field together with nack
};
